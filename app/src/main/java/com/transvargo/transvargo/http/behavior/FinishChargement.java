...
public class FinishChargement extends HttpRequest {

    private Chargement chargement;
    private String url;
    private ResponseHandler handler;

    public FinishChargement(Chargement chargement, ResponseHandler handler)
    {
        this.chargement = chargement;
        this.handler = handler;
        this.url = String.format(ApiTransvargo.FINISH_EXPEDITION, Boot.getTransporteurConnecte().identite.id);
    }
