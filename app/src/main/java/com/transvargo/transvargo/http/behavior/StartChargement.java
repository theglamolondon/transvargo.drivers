...
public class StartChargement extends HttpRequest {

    private Chargement chargement;
    private String url;
    private ResponseHandler handler;

    public StartChargement(Chargement chargement, ResponseHandler handler)
    {
        this.chargement = chargement;
        this.handler = handler;
        this.url = String.format(ApiTransvargo.START_EXPEDITION, Boot.getTransporteurConnecte().identite.id);
    }
